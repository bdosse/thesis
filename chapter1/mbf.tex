...
Par le~\Cref{thm:kolmogorov}, le mouvement Brownien fractionnaire peut
...
\begin{proof}
  ...
  et d'appliquer le~\Cref{thm:kolmogorov}.
...
\Cref{sec:hilbert-operators} pour en connaître une démonstration.
...
\begin{remarque}
  La convergence de la série du~\Cref{thm:orthogonal-decomp} est
  uniforme.
\end{remarque}
